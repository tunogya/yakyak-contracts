...
/**
  ...
  * @notice The Pass extends the standard ERC20 and ControlledToken interfaces with time-weighted average balance functionality.
...
*/
contract Pass is ControlledToken, IPass {
    ...
    /**
     * @notice Constructs Pass with passed parameters.
    ...
    function delegateWithSignature(
        ...
        require(block.timestamp <= _deadline, "Pass/delegate-expired-deadline");
        ...
        require(signer == _user, "Pass/delegate-invalid-signature");
    ...
    function _getAverageBalancesBetween(
        ...
        require(startTimesLength == _endTimes.length, "Pass/start-end-times-length-match");
    ...
    function _decreaseTotalSupplyTwab(uint256 _amount) internal {
        ...
        (
            ...
            bool tsIsNew
                ...
                totalSupplyTwab,
                _amount.toUint208(),
                "Pass/burn-amount-exceeds-total-supply-twab",
                uint32(block.timestamp)
            );
